package fr.locapov.app.repository;

import fr.locapov.app.UaaApp;
import fr.locapov.app.config.Constants;
import fr.locapov.app.config.audit.AuditEventConverter;
import fr.locapov.app.domain.PersistentAuditEvent;
...
import static fr.locapov.app.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
